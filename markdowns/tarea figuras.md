...
```python
"""
PROGRAMA: Dibujo mediante primitivas
DESCRIPCIÓN:
   Este programa dibuja una flor usando primitivas gráficas con OpenCV. Utiliza líneas,
   rectángulos y círculos para formar la estructura de una planta con pétalos, tallo
   y maceta en una imagen blanca.
"""
